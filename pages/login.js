    ...
    return (
        <Layout>
            <div className="md:w-4/5 xl:w-3/5 mx-auto mb-32">
                <h2 className="text-4l font-sans uppercase font-bold text-gray-800 text-center my-4">Iniciar sesion</h2>
                <div className="flex justify-center mt-5">
                    <div className="w-full max-w-lg">
                        <form className="bg-white-rounded shadow-md px-8 py-6 mb-4" onSubmit={ formik.handleSubmit }>
                            ...
                            <button className="w-full text-sm text-white mt-8 bg-red-500 hover:bg-red-600 hover:text-gray-200 active:bg-red-500 font-bold uppercase block text-center px-4 py-3 rounded outline-none focus:outline-none  ease-linear transition-all duration-150" type="submit">Iniciar sesion</button>
                        </form>
                    </div>
                </div>
            </div>
