        ...
        <div className="w-full mt-20">
            <div className="mb-3">
                ...
                <div className="relative inline-flex self-center w-full transition duration-100 ease-in-out group">
                    ...
                    <select onChange={ e => agregarDescargas(parseInt(e.target.value)) } className="w-full h-12 pl-5 pr-10 text-lg text-gray-800 transition duration-500 ease-in-out bg-white border-2 border-red-500 rounded appearance-none cursor-pointer group-hover:border-red-600 focus:outline-none">
